...
<head>
<base href=<%=basePath%>>
<title>文档审核 - Windows 小游戏研究学会</title>
...
function ChangeMeeting(){
	...
	document.getElementById("filelist").src = "filemgmt/filelist?meetingId=" + meetingId;
}
</script>
</head>
...
<iframe id="filelist" src="" width="100%" height="500px" frameborder="0"></iframe>
